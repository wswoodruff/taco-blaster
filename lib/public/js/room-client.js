...
exports.getRoomClient = async (props = {}) => {
    ...
    const updateRoom = async ({ roomId, userId, ...rest }) => {
        ...
        if (user) {
            roomUserId = user.id;
            const myTacoElEl = document.getElementById(MY_CURSOR_ID);
    ...
    const myTacoEl = document.getElementById(MY_CURSOR_ID);
    ...
    const initSocket = async () => {
        ...
        // Init chat room
        updateChatRoomMessages({ roomId: ROOM_ID, messages: [] });
        ...
        const onRoomUpdate = (props) => {
            ...
            if (chat) {
                updateChatRoomMessages({ roomId: ROOM_ID, messages: chat });
            }
        ...
        await RoomClient.subscribe(`/rooms/${ROOM_ID}`, onRoomUpdate);
    };
