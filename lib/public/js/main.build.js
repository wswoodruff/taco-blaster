      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            wsLocation = url.includes('3001') ? 'localhost:3000' : url;
            console.log('wsLocation', wsLocation);
            console.log('`wss://${wsLocation}`', "wss://".concat(wsLocation));
