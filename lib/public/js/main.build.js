          ...
          case 21:
            ...
            onRoomUpdate = function onRoomUpdate(props) {
              ...
              var newGhostIds = getIds(usersNotMe).filter(function (id) {
                return !Object.keys(roomUsers).includes(id);
              });
