          ...
          case 21:
            ...
            onRoomUpdate = function onRoomUpdate(props) {
              ...
              ghostTacos.forEach(function (tacoEl) {
                ...
                var tacoUpdate = usersNotMe.find(function (_ref6) {
                  var id = _ref6.id;
                  return id === tacoEl.id;
                });
                moveCursor({
              ...
              newGhostIds.forEach(function (id) {
                ...
                var userInfo = usersNotMe.find(function (_ref7) {
                  var id = _ref7.id;
                  return id === id;
                });
                moveCursor({
...
var run = function run() {
  initSocket();
  var throttledBroadcast = Throttle(function (_ref8) {
    var x = _ref8.x,
        y = _ref8.y;
