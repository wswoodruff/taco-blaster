...
var roomUserId = null; // Upsert user in room

var updateRoom = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var roomId, userId, x, y, payload, _yield$RoomClient$req, _yield$RoomClient$req2, error, user, connectionMsg;
...
var initSocket = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var wsLocation, user, roomEl, onRoomUpdate;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            wsLocation = window.location.host.includes('3001') ? 'localhost:3000' : window.location.host;
            console.log('wsLocation', wsLocation);

            if (window.location.protocol.includes('https')) {
              RoomClient = new Nes.Client("wss://".concat(wsLocation));
            } else {
              RoomClient = new Nes.Client("ws://".concat(wsLocation));
            }
