      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 13:
            ...
            // Setup some kinda easy debugging or something
            connectionMsg = document.getElementById('connectionMsg') || document.createElement('h3');
            connectionMsg.id = 'connectionMsg'; // let err = document.createElement(`<h3 style='color: white;'>Error ${error.message}</h3>`);
          ...
          case 21:
            user = _context2.sent;
            console.log('roomUserId', roomUserId); // subscribeGame
