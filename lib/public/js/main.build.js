...
var updateScore = function updateScore(_ref4) {
          ...
          case 21:
            ...
            onRoomUpdate = function onRoomUpdate(props) {
              ...
              if (scoreboard) {
                ...
                scoreboardEl.innerHTML = "<h3>Scoreboard</h3>".concat(scoreboard.map(function (_ref6) {
                  var userId = _ref6.userId,
                      score = _ref6.score;
                  return "<p>".concat(abbreviateUserId(userId), ": ").concat(score, "</p>");
                }).join(''));
                var myScore = (_roomScoreboard$find = roomScoreboard.find(function (_ref7) {
              ...
              Object.values(usersNotMe).forEach(function (_ref8) {
                var userId = _ref8.id,
                    _ref8$lastClick = _ref8.lastClick;
                _ref8$lastClick = _ref8$lastClick === void 0 ? {} : _ref8$lastClick;
                var epoch = _ref8$lastClick.epoch,
                    x = _ref8$lastClick.x,
                    y = _ref8$lastClick.y;
              ...
              remainingGhostTacos.forEach(function (tacoEl) {
                ...
                if (tacoUpdate) {
                  ...
                  updateScore({
                    element: tacoScore,
                    score: (_roomScoreboard$find2 = roomScoreboard.find(function (_ref11) {
              ...
              newGhostIds.forEach(function (id) {
                ...
                var userInfo = usersNotMe.find(function (_ref12) {
                  var id = _ref12.id;
                  return id === id;
                });
                moveCursor({
