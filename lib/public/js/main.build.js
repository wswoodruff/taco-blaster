...
var updateRoom = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var roomId, userId, rest, payload, _yield$RoomClient$req, _yield$RoomClient$req2, error, user, myTacoEl, connectionMsg;
            ...
            onRoomUpdate = function onRoomUpdate(props) {
              ...
              if (shouldDeleteUsers) {
                ...
                users.forEach(function (user) {
                  // Remove this taco
                  roomEl.removeChild(document.getElementById(user.id));
                });
                return;
              }
              ...
              ghostTacos.forEach(function (tacoEl) {
                var tacoExistsInUsers = Object.keys(roomUsers).includes(tacoEl.id);
...
var run = function run() {
  ...
  window.addEventListener('click', function (evt) {
    ...
    console.log('lastClick ZZZUUUUPPPPDATED', lastClick);
    throttledBroadcast();
  });
};
