...
const USE_NES = true;
const CURSOR_UPDATE_THROTTLE = 10; // 10 milliseconds — closer to 16 which would be 60 fps
...
const initSocket = async () => {
    ...
    const onRoomUpdate = (props) => {
        ...
        const newGhostIds = getIds(usersNotMe).filter((id) => !Object.keys(roomUsers).includes(id));
