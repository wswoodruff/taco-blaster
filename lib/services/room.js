...
const INACTIVE_USER_TIMEOUT = 8 * 1000; // 8 seconds
...
module.exports = class RoomService extends Schmervice.Service {
    ...
    initialize() {
        ...
        this.rooms = initRooms || getDefaultRooms();
    ...
    _setupThrottledRoomStateBroadcast() {
        ...
        // Hot path
        // TODO
        // Hmmmm not sure if I need to create a new Throttle
        // for each room or not — will figure out later
